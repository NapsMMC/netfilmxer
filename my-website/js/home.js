const API_KEY = 'f6a710d87dd1ed5bb52fb8fceea37efd';
...
function addScrollButtons(rowId) {
...
window.onload = () => {
  addScrollButtons('movies-list');
  addScrollButtons('tvshows-list');
  addScrollButtons('anime-list');
};
